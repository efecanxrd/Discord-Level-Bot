 ...
 * @property {string} [discriminator.discrim=null] The discriminator
...
class Rank {
    ...
    setAvatarColor(text = "#FFFFFF", number = "#FFFFFF") {
        if (!text || typeof text !== "string") text = "#FFFFFF";
        if (!number || typeof number !== "string") number = "#FFFFFF";
        this.data.status.color = text;
        return this;
    }
    setXpTextColor(text = "#FFFFFF", number = "#FFFFFF") {
        if (!text || typeof text !== "string") text = "#FFFFFF";
        if (!number || typeof number !== "string") number = "#FFFFFF";
        this.data.currentXP.color = text;
        this.data.requiredXP.color = text;
        return this;
    }
    setUsernameColor(text = "#FFFFFF", number = "#FFFFFF") {
        if (!text || typeof text !== "string") text = "#FFFFFF";
        if (!number || typeof number !== "string") number = "#FFFFFF";
        this.data.username.color = text;
        return this;
    }
    setRankAndLevelTextColor(text = "#FFFFFF", number = "#FFFFFF") {
        if (!text || typeof text !== "string") text = "#FFFFFF";
        if (!number || typeof number !== "string") number = "#FFFFFF";
        this.data.rank.textColor = text;
        this.data.level.textColor = text;
    ...
    async build(ops = { fontX: "MANROPE_BOLD,NOTO_COLOR_EMOJI", fontY: "MANROPE_BOLD,NOTO_COLOR_EMOJI" }) {
        ...
        if (discrim) {
            ...
            ctx.fillText(` `, ctx.measureText(name).width + 20 + 335, 164);
        }
